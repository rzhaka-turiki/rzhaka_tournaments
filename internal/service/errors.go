...
var (
	...
	ErrApexAccountNotFound           = errors.New("apex account not found")
	ErrApexAccountAlreadyLinked      = errors.New("apex account already linked")
	ErrApexAccountAlreadyUsed        = errors.New("apex account already used")
	ErrApexAccountVerificationFailed = errors.New("apex account verification failed")
)
